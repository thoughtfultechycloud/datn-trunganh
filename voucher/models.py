...
class Invoice(models.Model):
    ...
    reason          = models.CharField(max_length=300, blank=True, verbose_name='Lí do')
    ...
    total_amount    = models.DecimalField(max_digits=18, decimal_places=2, default=0, editable=False, verbose_name='Tổng tiền')
    ...
    class Meta:
        ...
        verbose_name_plural = 'Phiếu mua hàng'
    ...
    def vat_amount(self):
        ...
        return 0
    vat_amount.fget.short_description = 'Tiền thuế GTGT (10%)'
...
class InvoiceLineItem(models.Model):
    invoice   = models.ForeignKey(Invoice, on_delete=models.CASCADE, related_name='line_items', verbose_name='Phiếu mua hàng')
    item_name = models.CharField(max_length=200, verbose_name='Tên hàng hóa / dịch vụ')
    amount    = models.DecimalField(max_digits=18, decimal_places=2, default=0, verbose_name='Thành tiền')
