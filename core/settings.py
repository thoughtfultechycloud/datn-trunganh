...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-&7q7l)50*+)efg-l#co3!lx-yqh77^@!fzaa)xeb4t^*4g9oz0')
...
DATABASES = {
    'default': {
        ...
        'NAME':     os.environ.get('DB_NAME', 'aibox'),
        'USER':     os.environ.get('DB_USER', 'aibox'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'aibox123'),
